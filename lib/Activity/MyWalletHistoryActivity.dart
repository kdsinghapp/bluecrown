...
import 'package:bluecrown/Controller/MyWalletHistoryController.dart';
...
class MyWalletHistoryActivity extends StatefulWidget{
  const MyWalletHistoryActivity({super.key});

  @override
  State<MyWalletHistoryActivity> createState() =>_MyWalletHistoryState();
}
class _MyWalletHistoryState extends State<MyWalletHistoryActivity>{
  MyWalletHistoryController controller=Get.put(MyWalletHistoryController());
  @override
  Widget build(BuildContext context){
    return Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: primary3Color,
          elevation: 0.px,
          title: Center(child: Text('My Wallet History',style: MyTextStyle.titleStyle18bb,)),
          leading: SizedBox(
            height: 40.px,
            width: 40.px,
            child: Card(
        ...
        Column(
          ...
          children: [
            ...
            const Text("There are not present your wallet history",style: TextStyle(fontWeight: FontWeight.normal,
                fontSize: 14,color: Colors.redAccent),textAlign: TextAlign.center,):
            Expanded(
              child: SingleChildScrollView(
                scrollDirection: Axis.vertical,
                child:showWalletHistoryList() ,
              ),
            ),)
  ...
  /// Show My Wallet history List...
  Widget showWalletHistoryList(){
    ...
    ListView.builder(
      ...
      scrollDirection: Axis.vertical,
      itemCount: controller.myWalletHistoryModel!.result!.length,
      itemBuilder: (context, int index) {
        MyWalletHistoryResult item=controller.myWalletHistoryModel!.result![index];
          ...
          child:Card(
            ...
            child: Container(
                ...
                child: ListTile(
                  ...
                  title: Text(item.message!,style: MyTextStyle.titleStyle14b,),
                  ...
                  trailing: Column(
                    ...
                    children: [
                      ...
                      Text(item.points!,style: MyTextStyle.titleStyle14b,),
                    ],
                  ),
                )
            ),
