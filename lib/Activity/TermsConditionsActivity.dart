...
import 'package:bluecrown/Controller/TermsCondtionsController.dart';
...
class TermsConditionsActivity extends StatefulWidget {
  const TermsConditionsActivity({super.key});

  @override
  State<TermsConditionsActivity> createState() => _TermsConditionsState();
}

class _TermsConditionsState extends State<TermsConditionsActivity> {
    ...
    return Scaffold(
      ...
      SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(StringConstants.termsCondition,style: MyTextStyle.titleStyle24bb,),
