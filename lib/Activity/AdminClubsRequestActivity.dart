...
class _AdminClubsRequestState extends State<AdminClubsRequestActivity> {
  AdminClubsRequestController controller=Get.put(AdminClubsRequestController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(StringConstants.currentClubs,style: MyTextStyle.titleStyle20bb,),
        centerTitle: true,
        actions: [
          Padding(
        ...
        children: <Widget>[
            ...
            children: [
              Expanded(
                  ...
                  child: GestureDetector(
                    ...
                    child: Column(
                      children: [
                        Text("Clubs",style: MyTextStyle.titleStyle18bb,),
                        SizedBox(height: 5.px,),
                        Obx(() =>  Visibility(
              ...
              Expanded(
                  ...
                  child: GestureDetector(
                    ...
                    child: Column(
                      children: [
                        Text("Clubs Request",style: MyTextStyle.titleStyle18bb,),
                        SizedBox(height: 5.px,),
                        Obx(() =>  Visibility(
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Obx(() => controller.tab.value==0?showCurrentClubsList():showAllRequestedClubsList()),
            ...
            child:ListView.builder(
                ...
                itemBuilder: (BuildContext context,int index){
                  return  Container(
                    height: 70.px,
                    width: double.infinity,
                    margin: EdgeInsets.only(left: 10.px,right: 10.px,top: 10.px,bottom: 0.px),
                    ...
                    child:ListTile(
                      leading:  Container(
                        ...
                        margin: EdgeInsets.only(left: 10.px,right: 10.px,top: 5.px),
                        decoration:BoxDecoration(
    ...
    return GetBuilder<AdminClubsRequestController>(builder: (context) {
      return
        ...
        ListView.builder(
          ...
          itemBuilder: (context, int index) {
            GetClubRequestResult item=controller.getClubRequestModel!.result![index];
            return GestureDetector(
              onTap: () {
                // controller.openListEventActivity(item.id!,item.image!);
              },
              child:Container(
                ...
                child:    ListTile(
                  ...
                  title:Text(item.fullName!,style: MyTextStyle.titleStyle16bb,) ,
                  subtitle: Text(item.status!,style: MyTextStyle.titleStyle12blb,),
  ...
  void openAlertBox(BuildContext context,GetClubRequestResult model){
    showDialog(
      ...
      builder: (ctx)=>AlertDialog(
        title:  Center(child: Text("Club/Host Details",style: MyTextStyle.titleStyle24bb,)),
        ...
        content:  Container(
            ...
            child:Column(
              children: [
                ListTile(
                  leading:Text('Name :',style: MyTextStyle.titleStyle14b,) ,
                  title:Text(model.fullName!,style: MyTextStyle.titleStyle14bb,) ,
                  horizontalTitleGap: 1.px,
                ),
                ListTile(
                  leading:Text('Address :',style: MyTextStyle.titleStyle14b,) ,
                  title:Text(model.address!,style: MyTextStyle.titleStyle14bb,) ,
                  horizontalTitleGap: 1.px,
                ),
                ListTile(
                  leading:Text('Email :',style: MyTextStyle.titleStyle14b,) ,
                  title:Text(model.email!,style: MyTextStyle.titleStyle14bb,) ,
                  horizontalTitleGap: 1.px,
                ),
                ListTile(
                  leading:Text('Status :',style: MyTextStyle.titleStyle14b,) ,
            ...
            children: [
              CommonWidget.commonElevatedButton(
                  onPressed: ()async {
                   ...
                   controller.callingUpdateClubRequestForm(model.id!,'Accepted');
                  },
              ...
              CommonWidget.commonElevatedButton(
                  onPressed: (){
                    Get.back();
                    controller.changeLoading(true);
                    controller.callingUpdateClubRequestForm(model.id!,'Rejected');
                  },
