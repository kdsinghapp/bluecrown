...
class _MainState extends State<MainActivity> {
  ...
  Widget bottomNavigationWidgets() {
    return Container(
      ...
      decoration: const BoxDecoration(color: primary3Color),
      child: Obx(
        () => Row(
          ...
          children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  color: Colors.black,
                                  borderRadius:
                                      BorderRadius.all(Radius.circular(1.px))),
                            )
                          ],
                        )
                      : Column(
            ...
            Expanded(
                ...
                child: GestureDetector(
                  ...
                  child: bottomBarController.bottomNavIndex.value == 4
                      ? Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Image.asset(
                              IconsConstants.moreIcon,
                              height: 25.px,
                              width: 25.px,
                              fit: BoxFit.fill,
                            ),
    ...
    return Scaffold(
        ...
        body: Column(
          ...
          children: [
            SafeArea(
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                      onTap: () {
                        controller.openWardrobeActivity();
                      },
                      child: Image.asset(
                        IconsConstants.wordRobeIcon,
                        height: 50.px,
                        width: 50.px,
                        fit: BoxFit.fill,
                      )),
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: 5.px, right: 5.px, top: 10.px, bottom: 0.px),
                        child: GestureDetector(
                            onTap: () {
                              controller.openMainQrCodeActivity();
                            },
                            child: Image.asset(
                              IconsConstants.scanIcon,
                              height: 30.px,
                              width: 30.px,
                              fit: BoxFit.fill,
                            )),
                      ...
                      Padding(
                        padding: EdgeInsets.only(
                            left: 5.px, right: 5.px, top: 10.px, bottom: 10.px),
                        child: GestureDetector(
                            onTap: () {},
                            child: Image.asset(
            ...
            Padding(
              padding: EdgeInsets.only(left: 20.px, top: 0.px),
              child: Text(
                StringConstants.nearByEvents,
