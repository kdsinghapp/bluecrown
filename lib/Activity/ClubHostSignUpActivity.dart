...
class ClubHostSignUpActivity extends StatefulWidget {
  const ClubHostSignUpActivity({super.key});

  @override
  State<ClubHostSignUpActivity> createState() => _ClubHostSignUpState();
}

class _ClubHostSignUpState extends State<ClubHostSignUpActivity> {
  ClubHostSignUpController controller=Get.put(ClubHostSignUpController());
                ...
                children: <Widget>[
                  ...
                  Card(
                    ...
                    Container(
                      ...
                      child: GetBuilder<ClubHostSignUpController>(builder: (context) {
