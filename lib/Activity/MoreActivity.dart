            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Obx(() => controller.isPresentData.value
                      ? Column(
                          children: [
                            SizedBox(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  imageUrl: controller.userData.result!.image!,
                                  fit: BoxFit.cover,
                                  width: 80,
                                  height: 80.px,
                                  placeholder:
                            ...
                            Text(
                              controller.userData.result!.fullName ?? "",
                  ...
                  moreProfileList(),
                  Obx(
                    () => controller.isPresentData.value
                        ? Visibility(
                            visible: controller.userData.result!.type == "User"
                                ? false
                                : true,
                            child: Column(
                              children: [
          ...
          children: [
            ListTile(
              ...
              leading: SizedBox(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(20),
                  child: Image.asset(controller.moreIconList[index],
                      fit: BoxFit.cover),
                ),
              ),
              title: Text(
