...
import 'package:bluecrown/Controller/NewPasswordController.dart';
...
class NewPasswordActivity extends StatefulWidget {
  const NewPasswordActivity({super.key});

  @override
  State<NewPasswordActivity> createState() => _NewPasswordState();
}

class _NewPasswordState extends State<NewPasswordActivity> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(StringConstants.createNewPassword,style: MyTextStyle.titleStyle24bb,),
