...
class _ClubAllEventState extends State<ClubAllEventActivity> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          Text('${controller.parameterData['clubName']}\nAll Event List ',style: MyTextStyle.titleStyle18bb,textAlign: TextAlign.center,),
          Card(
            shape: RoundedRectangleBorder(
            ...
            child: TextFormField(
              ...
              onChanged: (text) {
                controller.changeFilterEventList(controller.searchController.text);
              },
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(item.style!, style: MyTextStyle.titleStyle14b,),
                          Text('${item.fromDate!} to ${item.fromDate!}', style: MyTextStyle.titleStyle14b,),
  ...
  /// Show Alert Box...
  void openAlertBox(BuildContext context,PublishMyEventResult model,int index){
    showDialog(
      context: context,
      builder: (ctx)=>AlertDialog(
        title:  Center(child: Text(model.name!,style: MyTextStyle.titleStyle24bb,textAlign: TextAlign.center,)),
        ...
        content:  Container(
            height: 170.px,width: MediaQuery.of(context).size.width-60.px,
              ...
              children: [
                ListTile(
                  leading:Padding(
                    ...
                    child: Text('Points :',style: MyTextStyle.titleStyle14b,),
                  ) ,
                  title:SizedBox(
                    height: 20.px,
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text(model.points!,style: MyTextStyle.titleStyle14bb,textAlign: TextAlign.center,),
                        SizedBox(width: 10.px,),
                        Image.asset(IconsConstants.subCrownIcon,width: 25.px,height: 20.px,fit: BoxFit.fill,),
                      ],
                    ),
                  ) ,
                ...
                ListTile(
                  leading:Padding(
                    padding: EdgeInsets.only(top: 3.px),
                    child: Text('Entrance Cost :',style: MyTextStyle.titleStyle14b,),
                  ) ,
                  title:SizedBox(
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text(model.entranceCost!,style: MyTextStyle.titleStyle14bb,textAlign: TextAlign.center,),
                        SizedBox(width: 10.px,),
                        Image.asset(IconsConstants.subCrownIcon,width: 25.px,height: 20.px,fit: BoxFit.fill,),
                      ],
                    ),
