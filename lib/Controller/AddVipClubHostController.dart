...
class AddVipClubHostController extends GetxController{
  ...
  Future<void> callingSubmitVipRegistrationForm() async {
    ...
    getSingUpModel = await ApiMethods.submitVipClubHostForm(
