...
class ChangeEventController extends GetxController{
  ...
  changeDateList(List<DateTime?>dataList){
    datesList=dataList;
    String dateStr=datesList[0].toString().substring(0,10)+" to "+datesList[datesList.length-1].toString().substring(0,10);
