class ApiUrlConstants {
  ...
  static const String endPointOfSubmitFriendsRequest ='${baseUrl}send_request_to_friend';
  static const String endPointOfClubAddCostomerRequest ='${baseUrl}add_club_friend';
  static const String endPointOfAddEvent='${baseUrl}add_event';
  static const String endPointOfUpdateEvent='${baseUrl}update_event';
  static const String endPointOfUpdateClubRequest='${baseUrl}update_club_request';
  static const String endPointOfGetMyPublishEvent = '${baseUrl}get_my_publish_event';
  ...
  static const String endPointOfGetCurrentJacket='${baseUrl}get_current_jacket';
  static const String endPointOfGetEarnMorePoint='${baseUrl}get_earn_more_point';
  static const String endPointOfGetWardrobeUserList='${baseUrl}get_wardrobe_user_list';
  static const String endPointOfGetClubFriendList='${baseUrl}get_club_friend_list';
  static const String endPointOfBookEvent='${baseUrl}book_event';
  static const String endPointOfGetBookingRequest='${baseUrl}get_booking_request';
