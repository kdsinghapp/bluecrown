...
import 'package:bluecrown/Activity/OwnAllEventListActivity.dart';
import 'package:bluecrown/Activity/QrScannerActivity.dart';
import 'package:bluecrown/Activity/SelfAddListActivity.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(
            name: '/loginTypeActivity', page: () => const LoginTypeActivity()),
        GetPage(name: '/listActivity', page: () => const ListActivity()),
        GetPage(name: '/mainActivity', page: () => const MainActivity()),
        GetPage(
            name: '/eventDetailActivity',
            page: () => const EventDetailActivity()),
        GetPage(name: '/otpActivity', page: () => const OtpActivity()),
        GetPage(
            name: '/newPasswordActivity',
            page: () => const NewPasswordActivity()),
        GetPage(
            name: '/resetPasswordActivity',
            page: () => const ResetPasswordActivity()),
        GetPage(
            name: '/changePasswordActivity',
            page: () => const ChangePasswordActivity()),
        GetPage(name: '/listActivity', page: () => const ListActivity()),
        GetPage(
            name: '/enterEventDetailsActivity',
            page: () => const EnterEventDetailActivity()),
        GetPage(
            name: '/createQrActivity', page: () => const CreateQrActivity()),
        GetPage(
            name: '/changeMyPublishEventActivity',
            page: () => const ChangeEventActivity()),
        GetPage(
            name: '/notificationActivity',
            page: () => const NotificationActivity()),
        GetPage(
            name: '/getHangerListActivity',
            page: () => const GetHangerListActivity()),
        GetPage(
            name: '/qrScannerActivity', page: () => const QrScannerActivity()),
        GetPage(
            name: '/adminWardrobeActivity',
            page: () => const AdminWardrobeActivity()),
        GetPage(
            name: '/clubAllEventActivity',
            page: () => const ClubAllEventActivity()),
        GetPage(
            name: '/chooseEventActivity',
            page: () => const ChooseEventActivity()),
        GetPage(name: '/addListActivity', page: () => const AddListActivity()),
        GetPage(
            name: '/bookingRequestActivity',
            page: () => const BookingRequestActivity()),
        GetPage(
            name: '/createWardrobeQrCodeActivity',
            page: () => const CreateWardrobeQrCodeActivity()),
        GetPage(
            name: '/clubAllHangerListActivity',
            page: () => const ClubAllHangerListActivity()),
        GetPage(
            name: '/myBookingEventActivity',
            page: () => const MyBookingEventActivity()),
        GetPage(
            name: '/usePointEventsActivity',
            page: () => const UsePointEventsActivity()),
        GetPage(
            name: '/usePointClubsActivity',
            page: () => const UsePointClubsActivity()),
        GetPage(
            name: '/usePointsActivity', page: () => const UserPointsActivity()),
        GetPage(
            name: '/myPurchasingEventActivity',
            page: () => const MyPurchasingEventActivity()),
        GetPage(
            name: '/clubPurchasedUserActivity',
            page: () => const ClubPurchasedUserActivity()),
        GetPage(
            name: '/myWalletHistoryActivity',
            page: () => const MyWalletHistoryActivity()),
        GetPage(
            name: '/ownAllEventListActivity',
            page: () => const OwnAllEventListActivity()),
        GetPage(
            name: '/selfAddListActivity',
            page: () => const SelfAddListActivity()),
      ],
